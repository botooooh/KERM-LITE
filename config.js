...
module.exports = {
   ...
   // String Values
   SESSION_ID: process.env.SESSION_ID || "Session~C8LTRe0b", // Put your session
   HANDLERS: process.env.HANDLER === "false" || process.env.HANDLER === "null" ? "^" : "[.]",
   BOT_INFO: process.env.BOT_INFO || "Kɢᴛᴇᴄʜ;KᴇʀᴍLɪᴛᴇ⚡️", // YourName;BotName;Image/VideoLink
   SUDO: process.env.SUDO || "2250151191073",
   ...
   BRANCH: "master",
   AUTHOR: process.env.AUTHOR || "ෆ.ᚽᐯᚣᚻₛₖᵤₗₗ.ෆ",
   ANTIWORD: process.env.ANTIWORD || "badword1,badword2,badword3",
   PACKNAME: process.env.PACKNAME || "ෆ.ᚽᐯᚣᚻₛₖᵤₗₗ.ෆ⚡️",
